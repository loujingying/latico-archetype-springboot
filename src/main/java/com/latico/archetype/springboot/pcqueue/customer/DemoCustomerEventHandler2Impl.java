 ...
 * @Version: 1.0
 */
public class DemoCustomerEventHandler2Impl implements EventHandler<OneArgEventDefault<DemoTimeParam>> {
    private static final Logger LOG = LoggerFactory.getLogger(DemoCustomerEventHandler2Impl.class);
    /**
     * 本处理器的名字
     */
    ...
    public DemoCustomerEventHandler2Impl() {
    }

    public DemoCustomerEventHandler2Impl(String name) {
        this.name = name;
    }
