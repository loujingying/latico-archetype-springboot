...
rem ---------------------------------------------------------------------------
set JAVA_OPTS=-server -Xms5m -Xmx2048m -Xss1m -XX:MaxMetaspaceSize=1024m -XX:MaxDirectMemorySize=1024m -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=%CATALINA_HOME%/logs/heap.dump -XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xloggc:%CATALINA_HOME%/logs/gc.log -Djava.awt.headless=true
setlocal
